...
public class TwitterClient extends OAuthBaseClient {
	public static final BaseApi REST_API_INSTANCE = TwitterApi.instance(); // Change this ********DONE
	public static final String REST_URL = "https://twitter.com/1.1"; // Change this, base API URL  *********DONE
